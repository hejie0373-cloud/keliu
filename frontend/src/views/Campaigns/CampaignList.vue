...
<template>
  <div class="campaign-shell">
    ...
    <section class="metric-grid" v-reveal>
      <StatCard label="活动总数" :value="total" note="当前店铺累计创建" tone="accent" :delay="0" />
      <StatCard label="本页已发送" :value="sentCount" note="已完成触达任务" tone="success" :delay="0.06" />
      <StatCard label="本页排期中" :value="scheduledCount" note="等待后续发送" tone="warning" :delay="0.12" />
      <StatCard label="发送失败" :value="totalFailed" :note="`${totalDelivered} 条已成功触达`" tone="danger" :delay="0.18" />
    </section>

    <section class="campaign-panel" v-reveal>
